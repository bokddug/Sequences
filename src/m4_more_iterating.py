...
def sum_sequence(sequence):
    ...
    """
    # ------------------------------------------------------------------
    # DONOE: 3. Implement and test this function.
...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [11,14,16,96,23,53,-0.1]
    threshold = 55
    expected = 1
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([10,3,-3,4,0])
    print()
    print('Test 4 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 98
    actual = sum_first_n([50,60,-12,0], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = -30
    actual = sum_first_n([-10,-20,-3,-4], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
